          ...
          <div className="cs_top_header_in header-style2">
            <div className="cs_top_header_left header-info">
                <ul className="list-style-1">
                    {/* <li><i className="icon icon-bentol"></i>iStat Data Consult</li> */}
                    <li><a href="mailto:info@istatdataconsult.com"><i className="bi bi-envelope-fill icon"></i>info@istatdataconsult.com</a></li>
                  </ul>
            </div>
