                ...
                <div className="col-lg-5">
                    <div className="contact-content-wrap">
                        <div className="title-area twoT">
                            ...
                            <h2 className="sec-title">Let’s Turn Your <br/> <span className="bold">Data</span> Into Impact.</h2>
                            ...
                            <div className="contact-item">
                                ...
                                <div className="info">
                                    ...
                                    <div className="content">
                                        Consulting: <a href="tel:+8801234567890">+251 911 (1213) 14</a><br/>
                                        Corporate: <a href="tel:+995644356000">+251 911 (1213) 15</a>
                                    </div>
                                </div>
                            </div>
                            <div className="contact-item">
                                ...
                                <div className="info">
                                    ...
                                    <div className="content">
                                        <a href="mailto:info@istatdataconsult.com">info@istatdataconsult.com</a><br/>
                                        <a href="mailto:support@istatdataconsult.com">support@istatdataconsult.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="form-grid">
                                ...
                                <div className="form-group">
                                    <select className="custom-select" id="service" name="service" autoComplete="off">
                                        <option>What are you needing?</option>
